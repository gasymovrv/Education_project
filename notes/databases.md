...
### Разное
+ Что сделать если планируем много искать данные в таблице (по каким полям не знаем) и при этом много изменять?
  + Индекс на все поля - не оптимально, тут поможет **партицирование**
