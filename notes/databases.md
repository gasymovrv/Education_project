...
+ Типы индексов в PostgreSQL
    ...
    + GIN - Создание индекса GIN на колонке JSONB создаст индекс по каждому ключу и значению (даже вложенным) в пределах этого документа JSON. Также помогает индексировать текст для полнотекстового поиска
