...
### Партицирование
Партицирование – это метод разделения больших (исходя из количества записей, а не столбцов) таблиц на много маленьких по определенным критерием - например разбиение на партиции по годам.
+ Запросы при этом не надо переписывать/оптимизировать.
+ Поможет ускорить доступ если планируем много искать данные в таблице (по каким полям не знаем) и при этом много изменять.
