...
+ Garbage Collector - автоматическое управление памятью - heap (очень подробно [habr](https://habr.com/ru/post/269621/))
